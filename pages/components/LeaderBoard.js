  ...
  return [
    ...
    },
    {
      ...
      players: [
        ...
        { name: "Shakib Al Hasan", points: -402.0 },
        { name: "Imad Wasim", points: 0 },
        { name: "Liton Das", points: -71.0 },
        { name: "Naveen-ul-Haq", points: 0 },
        { name: "Chris Jordan", points: 0 },
        { name: "Dinesh Chandimal", points: -14.0 },
      ],
    },
    {
      name: "Mohan/Hemanth",
    ...
    },
    {
      ...
      players: [
        ...
        { name: "Kusal Perera", points: -104.0 },
      ],
    },
    {
      name: "Sai Pavan",
      players: [
        ...
        { name: "Mustafizur Rahman", points: -208.0 },
    ...
    },
    {
      ...
      players: [
        ...
        { name: "Soumya Sarkar", points: -18.0 },
        { name: "Shadab Khan", points: 0 },
        { name: "Mohammad Shahzad", points: 0 },
        { name: "Mahmudullah", points: -151.0 },
        { name: "Haris Rauf", points: 0 },
        { name: "Wanindu Hasaranga", points: -339.0 },
